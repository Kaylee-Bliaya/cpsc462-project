...
map_img = loadAndScaleImg('map/map_graphics/map.png', 'map')

# load and scale button images
btn1_img = loadAndScaleImg('map/map_graphics/btn1.png', 'btn')
btn2_img = loadAndScaleImg('map/map_graphics/btn2.png', 'btn')
btn3_img = loadAndScaleImg('map/map_graphics/btn3.png', 'btn')
btn4_img = loadAndScaleImg('map/map_graphics/btn4.png', 'btn')
btn5_img = loadAndScaleImg('map/map_graphics/btn5.png', 'btn')
btn6_img = loadAndScaleImg('map/map_graphics/btn6.png', 'btn')
btn7_img = loadAndScaleImg('map/map_graphics/btn7.png', 'btn')
btn8_img = loadAndScaleImg('map/map_graphics/btn8.png', 'btn')
btn9_img = loadAndScaleImg('map/map_graphics/btn9.png', 'btn')
btn10_img = loadAndScaleImg('map/map_graphics/btn10.png', 'btn')
menuBtn_img = loadAndScaleImg('map/map_graphics/menu.png', 'menu')
inventoryBtn_img = loadAndScaleImg('map/map_graphics/inventory.png', 'inventory')
